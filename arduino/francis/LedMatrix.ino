...
Animation animations[] = {wave, white, fade, eye, eyeMove, eyeSleep, eyeSuperBright, eyeBright, eyeExplode,eyeDizzy,eyeDizzy2,eyeStare,eyeExplodeSmall,eyeRoll,eyeJump,eyeJump2};
bool hasAccel = false;
enum Mode {
  NOTHING,
  NORMAL,
